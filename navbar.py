        ...
        children=[
            dbc.DropdownMenu(
                ...
                children=[
                    ...
                    dbc.DropdownMenuItem("Mean and Standard Deviation", href='/page-2'), # Hyperlink item that appears in the dropdown menu
                    dbc.DropdownMenuItem("Wavefront and FFT", href='/page-3'), # Hyperlink item that appears in the dropdown menu
                    dbc.DropdownMenuItem("2D Plot", href='/page-4'), # Hyperlink item that appears in the dropdown menu
                ],
            ),
        ],
